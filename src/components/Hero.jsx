                ...
                >
                    <div className="space-y-3">
                        <h2 className="text-sm md:text-base font-semibold tracking-wider text-slate-500 uppercase">
                            Business & Growth Analyst | Strategy | Financial Services & Tech
                        </h2>
                        <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif font-medium text-slate-900 leading-[1.1]">
                            Farhan <br />
                            <span className="text-slate-800">Bagwan.</span>
                        </h1>
                    </div>
                    ...
                    <div className="pt-12 flex gap-12 border-t border-slate-100 max-w-md mx-auto text-center min-[600px]:mx-0 min-[600px]:text-left">
                        <div>
                            <p className="text-3xl font-serif text-slate-900">20+</p>
                            <p className="text-sm text-slate-500 mt-1 uppercase tracking-wide">Client Accounts</p>
                        </div>
                        <div>
                            <p className="text-3xl font-serif text-slate-900">90%</p>
                            <p className="text-sm text-slate-500 mt-1 uppercase tracking-wide">Blockers Resolved</p>
                        </div>
                    </div>
                </div>
