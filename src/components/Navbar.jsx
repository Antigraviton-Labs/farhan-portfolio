        ...
        >
            <div className="container mx-auto px-4 md:px-12 flex justify-between items-center">
                ...
                <div className="hidden md:flex space-x-10 items-center">
                    ...
                    <a href="/CV/Farhan_Bagwan_CV.pdf" target="_blank" rel="noopener noreferrer" className="ml-6">
                        ...
                        <SheetContent id="mobile-menu" side="right" className="w-[300px] sm:w-[400px]">
                            <div className="flex flex-col gap-4 mt-8 px-4">
                                ...
                                <div className="pt-6 border-t border-slate-200 mt-2 space-y-3">
                                    <a href="/CV/Farhan_Bagwan_CV.pdf" target="_blank" rel="noopener noreferrer" onClick={() => setIsSheetOpen(false)}>
